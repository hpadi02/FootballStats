...
const fetchPlayerData = async (teamId, season) => {
    try {
        // Connect to MongoDB
        await connectDB();
...
// Example usage: Fetch players for a specific team and season
fetchPlayerData(2, 2022); // Replace with desired team ID and season